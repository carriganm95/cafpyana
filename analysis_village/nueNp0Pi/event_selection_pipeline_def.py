...
from analysis_village.nueNp0Pi.final_selected_evt_vars import (
    CORE_SELECTED_EVT_VARIABLE_CONFIGS,
    with_final_selected_evt_variables,
)
from analysis_village.nueNp0Pi.categories import DETECTOR
from analysis_village.nueNp0Pi.makedf.selections import (
    ...
    get_trk_info, evt_has_trk1_trk2, fiducial_volume, contained, flash_matched, 
